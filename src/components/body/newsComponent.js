        ...
        <section id="section_1">
            ...
            <div className="tab-content">
                <div className="tab-pane container active" id="dienAnh">
                    <div className="row">
                        <div className="col-md-6 section_1">
                            <a href="#" className="item_2"><img src="./imgs/khai-truong-rap-xin-gia-ngon-chuan-xi-tai-sai-gon-16111317082644.jpg" alt /></a>
                        ...
                        <div className="col-md-6 section_1">
                            <a href="#" className="item_2"><img className="rounded" src="./imgs/boc-tem-to-hop-giai-tri-moi-toanh-cua-gioi-ha-thanh-16056938333773.jpg" alt /></a>
                            <a href="#" className="item_3">
                                <h6 className="mb-3">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-4 section_small">
                                <div className="d-flex">
                                    <div className="img">
                                        <a href="#"><img className="rounded" src="./imgs/da-n-my-nhan-trong-the-gio-i-die-n-a-nh-cu-a-qua-i-kie-t-christopher-nolan-15970503793246.png" alt /></a>
                                    </div>
                                ...
                                <div className="d-flex">
                                    <div className="img">
                                        <a href="#"><img className="rounded" src="./imgs/truy-cung-giet-tan-cuoc-tai-ngo-cua-hai-ong-hoang-phong-ve-xu-han-15966122262210.png" alt /></a>
                                    </div>
                                    <div className="text_a">
                                        <a href="#" className="item_3">
                                            <h6 className="mb-3">
                ...
                <div className="tab-pane container fade" id="review">
                    <div className="row">
                        <div className="col-md-6 section_1">
                            <a href="#" className="item_2"><img className="rounded" src="./imgs/review-tan-tich-quy-am-relic-ba-the-he-va-moi-lien-ket-15965255784224.png" alt /></a>
                            <a href="#" className="item_3">
                                <h6 className="mb-3">
                        ...
                        <div className="col-md-6 section_1">
                            <a href="#" className="item_2"><img className="rounded" src="./imgs/review-dinh-thu-oan-khuat-ghost-of-war-15965120886610.png" alt /></a>
                            <a href="#" className="item_3">
                                <h6 className="mb-3">
                    ...
                    <div className="row mt-3">
                        <div className="col-md-4 section_1">
                            <a href="#"><img className="rounded" src="./imgs/blackkklansman-coc-nuoc-lanh-de-nguoi-my-thuc-tinh-15910862294165.png" alt /></a>
                            <a href="#" className="item_3">
                                <h6 className="mb-3">
                        ...
                        <div className="col-md-4 section_1">
                            <a href="#"><img className="rounded" src="./imgs/american-sniper-chinh-nghia-hay-phi-nghia-15905660338111.png" alt /></a>
                            <a href="#" className="item_3">
                                <h6 className="mb-3">
                        ...
                        <div className="col-md-4 section_small">
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/review-bloodshot-mo-man-an-tuong-cho-vu-tru-sieu-anh-hung-valiant-15840731141389.jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/review-spider-man-into-the-spider-vesre-15886520889426.png" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/covid-19-la-ban-chinh-thuc-cua-mev-1-phim-contagion-2011-15843496198482.jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/review-sieu-ve-si-so-vo-giai-cuu-tong-thong-chua-bao-gio-lay-loi-va-hai-huoc-den-the-15840925506832 (1).jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                ...
                <div className="tab-pane container fade" id="khuyenMai">
                    <div className="row container">
                        <div className="col-md-6 section_1">
                            <a href>
                                <img className="rounded" src="./imgs/bhd-59k-ve-ca-tuan-16088081864967.jpg" alt />
                            </a>
                            <a href="#" className="item_3">
                        ...
                        <div className="col-md-6 section_1">
                            <a href="#"><img className="rounded" src="./imgs/tix-1k-ve-ngai-chi-gia-ve-16045662877511.jpg" alt /></a>
                            <a href="#" className="item_3">
                    ...
                    <div className="row mt-3">
                        <div className="col-md-4 section_1">
                            <a href="#"><img className="rounded" src="./imgs/dong-gia-1k-ve-khi-mua-ve-qua-tix-16010092946804.png" alt /></a>
                            <a href="#" className="item_3">
                        ...
                        <div className="col-md-4 section_1">
                            <a href="#"><img className="rounded" src="./imgs/bhd-star-ve-chi-59-000d-ca-tuan-15937622264546.jpg" alt /></a>
                            <a href="#" className="item_3">
                        ...
                        <div className="col-md-4 section_small">
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/beta-cineplex-tro-lai-voi-hang-loat-uu-dai-lon-15889408112010.png" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/123phim-thu-6-khong-den-toi-uu-dai-huy-diet-11k-ve-anh-trai-yeu-quai-15746757294099 (1).jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/123phim-nhap-ma-psm30k-giam-ngay-30k-khi-dat-ve-phap-su-mu-ai-chet-gio-tay-15729439018211.jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
                            ...
                            <div className="d-flex">
                                <div className="img">
                                    <a href="#"><img className="rounded" src="./imgs/mega-gs-mot-doa-hoa-thay-ngan-loi-yeu-15713106082164.jpg" alt /></a>
                                </div>
                                <div className="text_a">
                                    <a href="#" className="item_3">
                                        <h6 className="mb-3">
